const projectData = [
  ...
  [{
    ...
    description: 'Working in a pair for 48 hours, we built a website filtering from the Cleveland Museum of Art’s API. We focused on Islamic Art and created pages to showcase different kinds of objects in the museum’s collection: decorative arts, textiles and books.',
  ...
  [{
    ...
    description: 'This week-long solo project’s brief was to select from a list of grid-based games and use vanilla JavaScript to build it. I built a version of Ultimate Tic Tac Toe, using a space theme. This was my first experience of any kind of programming project and artistic design.',
